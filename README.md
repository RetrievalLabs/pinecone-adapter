...
A production-ready Pinecone vector database adapter that integrates with [rag_control](https://github.com/RetrievalLabs/rag-control) for secure, governed RAG (Retrieval-Augmented Generation) applications.
...
- Open a [GitHub issue](https://github.com/RetrievalLabs/pinecone-adapter/issues)
- Contact: support@retrievallabs.com

## Related Resources

- [rag_control](https://github.com/RetrievalLabs/rag-control) - RAG governance framework
